...
Books on general-purpose programming that do not focus on a specific language are in listed in the subject "Programming". Books on specialized topics are listed in their own sub-sections.
